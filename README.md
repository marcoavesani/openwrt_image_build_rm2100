[[!Build Status](https://travis-ci.com/marcoavesani/openwrt_image_build_rm2100.svg?branch=master&status=passed](https://travis-ci.com/github/marcoavesani/openwrt_image_build_rm2100)
